...
grpc::Status SecurityServiceImpl::GetSecurity(grpc::ServerContext *context, const GetSecurityRequest *request,
                                              GetSecurityResponse *response) {
...
grpc::Status SecurityServiceImpl::ListSecurities(grpc::ServerContext *context, const ListSecuritiesRequest *request,
